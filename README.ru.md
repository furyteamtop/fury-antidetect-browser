...
| ~~Синхронизация бандлов с сервером~~ | сделано. Пакуется и запечатывается при закрытии, забирается и распаковывается при запуске, версионируется — второму загружающему отказ, а не молчаливая победа |
