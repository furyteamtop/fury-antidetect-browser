...
const en = {
  ...
  "err.proxyCheckNotBuilt": "Checking a proxy on a team server is not built yet — its credentials are sealed, and the check would run without them.",
  "app.retry": "Try again",
  "nav.users": "Users",
...
const ru: Record<Key, string> = {
  ...
  "err.proxyCheckNotBuilt": "Проверка прокси на командном сервере ещё не сделана — учётка запечатана, и проверка пошла бы без неё.",
  "app.retry": "Ещё раз",
