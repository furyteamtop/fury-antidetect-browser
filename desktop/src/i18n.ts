...
const en = {
  ...
  "pp.formats": "host:port, host:port:user:pass, user:pass@host:port, or scheme://user:pass@host:port. Lines starting with # are ignored.",
...
const ru: Record<Key, string> = {
  ...
  "pp.formats": "host:port, host:port:user:pass, user:pass@host:port или scheme://user:pass@host:port. Строки, начинающиеся с #, пропускаются.",
