...
const en = {
  ...
  "bar.allGroups": "All groups",
  "bar.ungrouped": "Ungrouped",
  "bar.openOnly": "Open ({n})",
  ...
  "pd.name": "Name",
  "pd.group": "Group",
  "pd.groupHint": "A label you invent while working — \"warmed\", \"to check\", \"client A\". Type a new one and it exists.",
  "pd.tags": "Tags",
  ...
  "proj.confirmDelete": "Delete \"{name}\"? Its {n} profiles go to the trash with it, and can be restored from there — restoring one brings the project back.",
...
const ru: Record<Key, string> = {
  ...
  "bar.allGroups": "Все группы",
  "bar.ungrouped": "Без группы",
  ...
  "pd.name": "Имя",
  "pd.group": "Группа",
  "pd.groupHint": "Метка, которую придумываете по ходу — «прогрет», «на проверку», «клиент А». Напечатали новую — она есть.",
  "pd.tags": "Метки",
  ...
  "proj.confirmDelete": "Удалить «{name}»? Профилей в нём: {n}. Они уйдут в корзину вместе с проектом, и оттуда их можно вернуть — восстановление профиля вернёт и проект.",
