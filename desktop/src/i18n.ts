...
const en = {
  ...
  "app.hereShort": "here",
  "app.newProjectLocalTip": "A folder on this machine, for profiles that are not on the server",
  "app.newProjectTeamTip": "A project on the server, shared with the team",
...
const ru: Record<Key, string> = {
  ...
  "app.hereShort": "тут",
  "app.newProjectLocalTip": "Папка на этой машине — для профилей, которых нет на сервере",
  "app.newProjectTeamTip": "Проект на сервере, общий для команды",
