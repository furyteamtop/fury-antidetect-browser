...
const en = {
  ...
  "up.confirm": "Send {n} profile(s) to the project \"{project}\"? The copies on this machine stay where they are.",
  "up.sending": "Sending…",
  "up.done": "\"{name}\" is on the server now. The copy on this machine is untouched.",
  "up.needsProxy": "It arrived without a proxy: proxies live in the team's own list, so attach one there before it is opened.",
...
const ru: Record<Key, string> = {
  ...
  "up.confirm": "Отправить профилей: {n} — в проект «{project}»? Копии на этой машине останутся на месте.",
  "up.sending": "Отправляю…",
  "up.done": "«{name}» теперь на сервере. Копия на этой машине не тронута.",
  "up.needsProxy": "Прокси не поехал: прокси живут в общем списке команды, поэтому привяжите его там до первого запуска.",
