...
const en = {
  ...
  "cred.empty": "No logins saved for this profile. A shared account's password and two-factor seed live here rather than in a group chat.",
  "cred.label": "Name",
  "cred.site": "Site",
...
const ru: Record<Key, string> = {
  ...
  "cred.empty": "Для этого профиля логинов нет. Пароль общего аккаунта и его второй фактор живут здесь, а не в переписке.",
  "cred.label": "Название",
  "cred.site": "Сайт",
  "cred.username": "Логин",
